...
import static com.google.cloud.pubsub.client.demos.appengine.controllers.RegisterPubSubController.ASYNC_ENDPOINT;
...
//        return new GloudPubSubClientEmulator(APPLICATION_NAME);
//    }

    @Bean public GCloudClientPubSub getPubSub(){
